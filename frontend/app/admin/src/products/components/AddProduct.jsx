  ...
  return (
    ...
    <div className='relative mb-4'>
          <div className='h-4 bg-gray-300 rounded-full'>
            ...
            >
              <span className='text-white text-xs font-medium'>{`${Math.round((step / totalSteps) * 100)}%`}</span>
            </div>
          </div>
        ...
        {step === 2 && (
          <>
            <div className='mb-4'>
              <label htmlFor='price' className='block text-md font-bold text-gray-700'>
                Precio
              </label>
              <input
                type='number'
            ...
            <div className='mb-4'>
              <label htmlFor='stock' className='block text-md font-bold text-gray-700'>
                Stock
              </label>
              <input
                type='number'
            ...
            <div className='flex flex-wrap gap-2 justify-center'>
              {categories.map((cat, index) => (
                <button
                  ...
                  className={`flex flex-col items-center justify-center w-24 h-24 border-2 rounded-md border-[#61005D] ${productData.category === cat.name ? 'bg-[#61005D] text-white' : 'bg-transparent text-[#61005D]'} focus:outline-none`}
                >
        ...
        {step === 4 && (
          <div className='mb-4'>
            <label htmlFor='description' className='block text-sm text-md font-bold text-gray-700'>
              Descripción
            </label>
            <textarea
              id='description'
        ...
        {step === 5 && (
          ...
          <article className='flex items-center gap-5'>
            ...
            <div className='mb-4'>
              <label htmlFor='identification' className='block text-md font-bold text-gray-700'>
                Imágenes
              </label>
            ...
            <div className='mb-4'>
              <label htmlFor='code' className='block text-md font-bold text-gray-700'>
                Código
              </label>
              <input
                type='text'
          ...
          <div>
            {step < totalSteps ? (
              <button
                ...
                className={`p-4 flex items-center border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${validateStep() ? 'bg-[#61005D] hover:bg-[#4A004F]' : 'bg-gray-300 cursor-not-allowed'}`}
              >
              ...
              <button
                ...
                className={`p-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${loading || !validateStep() ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#61005D] hover:bg-[#4A004F]'}`}              >
