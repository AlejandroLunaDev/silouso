...
class ProductsRouter extends Router {
  init() {
    ...
    this.post("/", ["ADMIN", "PREMIUM"], uploader.fields([{ name: "identification", maxCount: 10 }]), addProduct);

    this.put("/:pid", ["ADMIN", "PREMIUM"], uploader.fields([{ name: "identification", maxCount: 10 }]), updateProduct);
